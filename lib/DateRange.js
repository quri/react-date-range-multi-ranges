...
var DateRange = (function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function render() {
      ...
      var customOnRangeChange = _props.customOnRangeChange;
      ...
      return _react2['default'].createElement(
        ...
        ranges && _react2['default'].createElement(_PredefinedRangesJs2['default'], {
          format: format,
          ranges: ranges,
          includeContainedRanges: includeContainedRanges,
          customOnRangeChange: customOnRangeChange,
          range: range,
          theme: styles,
...
DateRange.propTypes = {
  ...
  firstDayOfWeek: _PropTypes.number,
  calendars: _PropTypes.oneOfType([_PropTypes.string, _PropTypes.number]),
  startDate: _PropTypes.oneOfType([_PropTypes.object, _PropTypes.func, _PropTypes.string]),
  endDate: _PropTypes.oneOfType([_PropTypes.object, _PropTypes.func, _PropTypes.string]),
  minDate: _PropTypes.oneOfType([_PropTypes.object, _PropTypes.func, _PropTypes.string]),
  maxDate: _PropTypes.oneOfType([_PropTypes.object, _PropTypes.func, _PropTypes.string]),
  includeContainedRanges: _PropTypes.bool,
  customOnRangeChange: _PropTypes.func,
  dateLimit: _PropTypes.func,
  ranges: _PropTypes.object,
  linkedCalendars: _PropTypes.bool,
