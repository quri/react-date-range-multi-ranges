...
Calendar.propTypes = {
  sets: _PropTypes.string,
  range: _PropTypes.shape({
  ...
  date: _PropTypes.oneOfType([_PropTypes.object, _PropTypes.string, _PropTypes.func]),
  format: _PropTypes.string.isRequired,
  firstDayOfWeek: _PropTypes.oneOfType([_PropTypes.number, _PropTypes.string]),
  onChange: _PropTypes.func,
  onInit: _PropTypes.func,
  link: _PropTypes.oneOfType([_PropTypes.shape({
    startDate: _PropTypes.object,
    endDate: _PropTypes.object
  }), _PropTypes.bool]),
  linkCB: _PropTypes.func,
